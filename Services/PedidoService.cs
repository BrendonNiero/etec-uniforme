...
public class PedidoService 
{
    public List<Pedido> GetPedidos()
    {
        return new List<Pedido>
        {
            ...
            new Pedido { Nome = "Emilly", Tamanhos = new List<string> { "M", "M" }, Pago = 90, TotalAPagar = 90 },
            ...
            new Pedido { Nome = "Prof. Leonardo", Tamanhos = new List<string> { "M" }, Pago = 45, TotalAPagar = 45 },
            ...
            new Pedido { Nome = "Bruno Emanuel", Tamanhos = new List<string> { "P", "P" }, Pago = 90, TotalAPagar = 90 },
            new Pedido { Nome = "Irene", Tamanhos = new List<string> { "PP" }, Pago = 45, TotalAPagar = 45 },
            ...
            new Pedido { Nome = "João Augusto", Tamanhos = new List<string> { "G", "G" }, Pago = 90, TotalAPagar = 90 },
            new Pedido { Nome = "Thaísa", Tamanhos = new List<string> { "BLP" }, Pago = 45, TotalAPagar = 45 },
            new Pedido { Nome = "Murieli", Tamanhos = new List<string> { "BLP", "BLP" }, Pago = 90, TotalAPagar = 90 },
            new Pedido { Nome = "Karla", Tamanhos = new List<string> { "BLM" }, Pago = 45, TotalAPagar = 45 },
            ...
            new Pedido { Nome = "Gabriel Bueno", Tamanhos = new List<string> { "M", "M" }, Pago = 90, TotalAPagar = 90 },
        };
    }
}